  ...
  return (
    <div className={styleMessageActive}>
      ...
      <div className={styles.userMessageCard__timeBox}>
        ...
        {unreadCountMessage && (
          <p className={styles.iconCountMessage}>{unreadCountMessage}</p>
        )}
      </div>
    </div>
  );
